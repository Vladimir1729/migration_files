...
with DAG(
    ...
    def validation_tree():
        ...
        try:
            ...
            #mapeo = pd.read_csv('/root/Documents/airdemo/id_mapping_recargaqui_prod_actual.csv')
            #id_mapping_recargaqui_prod_actual_id_mapping.csv
            mapeo = pd.read_csv('/root/Documents/airdemo/id_mapping_recargaqui_prod_actual_id_mapping.csv')
            #id_mapping_recargaqui_prod_actual_id_mapping.csv
            ...
            #origin_hook = MsSqlHook(mssql_conn_id='admin_migracion_recargaqui')
            #Conexion productiva
            origin_hook = MsSqlHook(mssql_conn_id='admin_origin_final_recargaqui')
            #dest_hook = MsSqlHook(mssql_conn_id='admin_destiny_recargaqui')
            dest_hook = MsSqlHook(mssql_conn_id='admin_destiny_final_recargaqui')
